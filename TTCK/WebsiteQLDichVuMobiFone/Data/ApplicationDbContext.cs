...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdbinhLuan).HasName("PK__BinhLuan__5CDBC03C06F22B7B");

            entity.Property(e => e.NgayBinhLuan).HasDefaultValueSql("(getdate())");

            entity.HasOne(d => d.IdTinTucNavigation).WithMany(p => p.BinhLuanBaiViets).HasConstraintName("FK__BinhLuanB__IdTin__4A8310C6");

            entity.HasOne(d => d.NguoiDung).WithMany(p => p.BinhLuanBaiViets).HasConstraintName("FK__BinhLuanB__Nguoi__4B7734FF");
        });

        modelBuilder.Entity<ChuDe>(entity =>
        {
            entity.HasKey(e => e.IdchuDe).HasName("PK__ChuDe__5C130CB81C8D0A23");
        });

        modelBuilder.Entity<CthoaDonDichVu>(entity =>
        {
            entity.HasKey(e => e.IdcthoaDonDv).HasName("PK__CTHoaDon__758AFF3590BA2B00");

            entity.Property(e => e.DonGia).HasDefaultValue(0);
            entity.Property(e => e.SoLuong).HasDefaultValue((short)1);

            entity.HasOne(d => d.IdgoiDangKyNavigation).WithMany(p => p.CthoaDonDichVus).HasConstraintName("FK__CTHoaDonD__IDGoi__2645B050");

            entity.HasOne(d => d.IdgoiDangKyDvkNavigation).WithMany(p => p.CthoaDonDichVus).HasConstraintName("FK__CTHoaDonD__IDGoi__2739D489");

            entity.HasOne(d => d.IdhoaDonDvNavigation).WithMany(p => p.CthoaDonDichVus).HasConstraintName("FK__CTHoaDonD__IDHoa__25518C17");
        });

        modelBuilder.Entity<CthoaDonDoanhNghiep>(entity =>
        {
            entity.HasKey(e => e.IdcthoaDonDn).HasName("PK__CTHoaDon__758AFF3DBFC89887");

            entity.HasOne(d => d.IdgoiDichVuNavigation).WithMany(p => p.CthoaDonDoanhNghieps)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTHoaDonD__IDGoi__40058253");

            entity.HasOne(d => d.IdhoaDonDnNavigation).WithMany(p => p.CthoaDonDoanhNghieps).HasConstraintName("FK__CTHoaDonD__IDHoa__3F115E1A");
        });

        modelBuilder.Entity<CthoaDonSim>(entity =>
        {
            entity.HasKey(e => e.IdcthoaDonSim).HasName("PK__CTHoaDon__447141A0CC83B92C");
            ...
            entity.HasOne(d => d.IdgoiDangKyNavigation).WithMany(p => p.CthoaDonSims)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTHoaDonS__IDGoi__3587F3E0");

            entity.HasOne(d => d.IdhoaDonSimNavigation).WithMany(p => p.CthoaDonSims).HasConstraintName("FK__CTHoaDonS__IDHoa__339FAB6E");

            entity.HasOne(d => d.IdsimNavigation).WithMany(p => p.CthoaDonSims)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CTHoaDonS__IDSim__3493CFA7");
        });

        modelBuilder.Entity<DichVu>(entity =>
        {
            entity.HasKey(e => e.IddichVu).HasName("PK__DichVu__C0C959282337E0C9");
        });

        modelBuilder.Entity<DichVuDoanhNghiep>(entity =>
        {
            entity.HasKey(e => e.IddichVuDn).HasName("PK__DichVuDo__64ECF549B366DD1E");
        ...
        {
            entity.HasKey(e => e.IdgoiDangKy).HasName("PK__GoiDangK__72344F028111B7D4");
        ...
        {
            entity.HasKey(e => e.IdgoiDangKy).HasName("PK__GoiDangK__72344F02A8DA5ABC");
        ...
        {
            entity.HasKey(e => e.IdgoiDichVu).HasName("PK__GoiDichV__A74519A3268900E0");
        ...
        {
            entity.HasKey(e => e.IdhoaDonDv).HasName("PK__HoaDonDi__C9D2DCF2CDD4154B");
            ...
            entity.HasOne(d => d.IdnguoiDungNavigation).WithMany(p => p.HoaDonDichVus)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HoaDonDic__IDNgu__1F98B2C1");

            entity.HasOne(d => d.IdtrangThaiNavigation).WithMany(p => p.HoaDonDichVus)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HoaDonDic__IDTra__22751F6C");
        });

        modelBuilder.Entity<HoaDonDoanhNghiep>(entity =>
        {
            entity.HasKey(e => e.IdhoaDonDn).HasName("PK__HoaDonDo__C9D2DCFA68961F08");

            entity.Property(e => e.NgayDatHang).HasDefaultValueSql("(getdate())");

            entity.HasOne(d => d.IdnguoiDungNavigation).WithMany(p => p.HoaDonDoanhNghieps)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HoaDonDoa__IDNgu__3A4CA8FD");

            entity.HasOne(d => d.IdtrangThaiNavigation).WithMany(p => p.HoaDonDoanhNghieps)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HoaDonDoa__IDTra__3C34F16F");
        });

        modelBuilder.Entity<HoaDonSim>(entity =>
        {
            entity.HasKey(e => e.IdhoaDonSim).HasName("PK__HoaDonSi__364462F7101D14C1");
            ...
            entity.HasOne(d => d.IdnguoiDungNavigation).WithMany(p => p.HoaDonSims)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HoaDonSim__IDNgu__2BFE89A6");

            entity.HasOne(d => d.IdphuongThucVcNavigation).WithMany(p => p.HoaDonSims)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HoaDonSim__IDPhu__30C33EC3");

            entity.HasOne(d => d.IdtrangThaiNavigation).WithMany(p => p.HoaDonSims)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HoaDonSim__IDTra__2EDAF651");

            entity.HasOne(d => d.IdtrangThaiThanhToanNavigation).WithMany(p => p.HoaDonSims)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HoaDonSim__IDTra__2FCF1A8A");
        });

        modelBuilder.Entity<LienHe>(entity =>
        {
            entity.HasKey(e => e.IdlienHe).HasName("PK__LienHe__002B7E19321FB0C7");
            ...
            entity.HasOne(d => d.IdnguoiDungNavigation).WithMany(p => p.LienHes)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__LienHe__IDNguoiD__114A936A");
        });

        modelBuilder.Entity<LoaiDichVuDiDong>(entity =>
        {
            entity.HasKey(e => e.IdloaiDichVu).HasName("PK__LoaiDich__7911AD8A809F0A32");
        ...
        {
            entity.HasKey(e => e.IdloaiDichVuKhac).HasName("PK__LoaiDich__680849BBCB35B0FE");
        ...
        {
            entity.HasKey(e => e.IdloaiGoi).HasName("PK__LoaiGoiD__1B03B7B1381A14B0");
        ...
        {
            entity.HasKey(e => e.IdloaiSo).HasName("PK__LoaiSo__B57A5AFA02433DEB");
        });

        modelBuilder.Entity<NguoiDung>(entity =>
        {
            entity.HasKey(e => e.IdnguoiDung).HasName("PK__NguoiDun__FCD7DB09D6C51632");
        ...
        {
            entity.HasKey(e => e.IdnhomDichVu).HasName("PK__NhomDich__9E06E4F3C98B4306");
        ...
        {
            entity.HasKey(e => e.IdphuongThucVc).HasName("PK__PhuongTh__A8430B5722E7FA84");
        ...
        {
            entity.HasKey(e => e.IdsanPham).HasName("PK__SanPhamD__9D45E58A4478FA62");
        ...
        {
            entity.HasKey(e => e.Idsim).HasName("PK__Sim__A5CFB83CC4F3F3B7");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Sim_GoiD__3214EC27943B0FEA");

            entity.Property(e => e.NgayDangKy).HasDefaultValueSql("(getdate())");

            entity.HasOne(d => d.IdgoiDangKyNavigation).WithMany(p => p.SimGoiDangKies).HasConstraintName("FK__Sim_GoiDa__IDGoi__08B54D69");

            entity.HasOne(d => d.IdsimNavigation).WithMany(p => p.SimGoiDangKies)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK__Sim_GoiDa__IDSim__07C12930");
        });

        modelBuilder.Entity<SimGoiDangKyDichVuKhac>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Sim_GoiD__3214EC27EBE8AC73");

            entity.Property(e => e.NgayDangKy).HasDefaultValueSql("(getdate())");

            entity.HasOne(d => d.IdgoiDangKyNavigation).WithMany(p => p.SimGoiDangKyDichVuKhacs).HasConstraintName("FK__Sim_GoiDa__IDGoi__0D7A0286");

            entity.HasOne(d => d.IdsimNavigation).WithMany(p => p.SimGoiDangKyDichVuKhacs)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK__Sim_GoiDa__IDSim__0C85DE4D");
        });

        modelBuilder.Entity<TinTuc>(entity =>
        {
            entity.HasKey(e => e.IdTinTuc).HasName("PK__TinTuc__B78296762BCEE3E6");

            entity.Property(e => e.LuotXem).HasDefaultValue(0);
            entity.Property(e => e.NgayDang).HasDefaultValueSql("(getdate())");

            entity.HasOne(d => d.IdTheLoaiNavigation).WithMany(p => p.TinTucs).HasConstraintName("FK__TinTuc__IdTheLoa__46B27FE2");
        });

        modelBuilder.Entity<TrangThaiDonHang>(entity =>
        {
            entity.HasKey(e => e.IdtrangThai).HasName("PK__TrangTha__556586009B32001E");
        });

        modelBuilder.Entity<TrangThaiSim>(entity =>
        {
            entity.HasKey(e => e.IdtrangThaiSim).HasName("PK__TrangTha__22D8CDF4C7A9D963");
        });

        modelBuilder.Entity<TrangThaiThanhToan>(entity =>
        {
            entity.HasKey(e => e.IdtrangThaiThanhToan).HasName("PK__TrangTha__6CB87881BB57A14A");
        });
